            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-item text-center">
                        ...
                        <h3 class="title">Edit Data Prestasi</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="panel-body">
                            <form action="<?php echo base_url('user/update-prestasi');?>" enctype="multipart/form-data" method="post">
                                 <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="kelas" required="required">
                                        ...
                                        foreach($data_kelas as $dataKelas){
                                            if($data_prestasi['id_kelas'] == $dataKelas['id_kelas']) {
                                                $sel="selected";
                                            }
                                            else{
                                                $sel="";
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <a href="<?php echo base_url('user/data-prestasi');?>"><button type="button" class="btn btn-danger">Batal</button></a>
                                </div>
                                <div style="clear:both;"></div>
                            </form>
                        </div>
